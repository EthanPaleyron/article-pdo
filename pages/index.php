...
<body>
    ...
    <a href="create-article.php">Créer un nouvel article</a>
            ...
            while ($e = $result->fetch()) {
                ...
                if (isset($_SESSION["id"])) {
                    if ($_SESSION["id"] == $e["LABEL_UTILISATEUR_ARTICLE"]) {
                        echo '<a href="update-article.php">Modifier</a>
                        ...
                        try {
                            include("../manager/connexion-base.php");
                            $sql = "SELECT LABEL_COMMENTAIRE FROM `sou-commentaires` WHERE LABEL_COMMENTAIRE = 46";
                            $idSouCommentaires = $base->query($sql);
                            $souCommentaires = $idSouCommentaires->fetch();
                            echo '<input type="hidden" name="id_sou_commentaires" value="' . $souCommentaires["LABEL_COMMENTAIRE"] . '">';
                        } catch (Exception $e) {
